...
Generated by Repomix on: 2025-06-15T18:51:54.749Z
...
const AttributesPage = () => {
  ...
  const bulkDeleteMutation = useMutation({
    mutationFn: async (ids: string[]) => {
      await Promise.all(
        ids.map(id =>
          sdk.client.fetch(`/admin/plugin/attributes/${id}`, {
            method: "DELETE"
          })
        )
      )
...
export const AdminCreateAttribute = z.object({
    name: z.string(),
    description: z.string().optional(),
    is_variant_defining: z.boolean().default(false), // Changed default to false
...
export const AdminUpdateAttribute = z.object({
    ...
    product_category_ids: z.array(z.string()).optional(), // Keep this for the API
}).strict()
```
